        ...
        btnCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(days > 0){
                    ...
                    Order order = new Order(currentUser.getEmail(),hotel.getHotelID(),room.getRoomID(), arrivalDate, departureDate, etGuestemail.getText().toString(),currentUser.getDisplayName());
                    Orders.add(order);
                }
            }
        });
